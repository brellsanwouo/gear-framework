(function (root, factory) {
  ...
  const mlflowBootstrap = (frameworkId) => [
    ...
    "        print(\"__GEAR_TRACE_START__\", file=_gear_sys.stderr)",
    "        print(_gear_json.dumps({\"trace_id\": _gear_root_span.trace_id}), file=_gear_sys.stderr)",
    "        print(\"__GEAR_TRACE_END__\", file=_gear_sys.stderr)",
